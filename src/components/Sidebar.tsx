...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <>
      ...
      >
        <div className="w-[272px] h-full bg-[#031d14] border-r border-emerald-950/70 shadow-[12px_0_38px_rgba(1,25,17,0.20)] flex flex-col overflow-hidden">
            ...
            <div className="p-3.5 pb-4">
              <div className="relative overflow-hidden rounded-[26px] border border-white/10 bg-white shadow-[0_18px_38px_rgba(0,0,0,0.20)]">
                ...
                <button
                  ...
                  className="relative z-10 flex min-h-[116px] w-full items-start px-4 pt-5 text-left"
                >
                  <div className="max-w-[162px]">
                    <div className="rounded-xl bg-white/96 px-2 py-1.5 shadow-sm ring-1 ring-slate-200/70">
                      <img
                        src={akbsLogoImg}
                    ...
                    <div className="mt-1.5 pl-1 text-[9.5px] font-semibold tracking-[-0.01em] text-emerald-900/60">
                      ...
                      {group.items.map((item) => {
                        ...
                        return (
                          <button
                            ...
                            className={`group relative w-full min-h-[42px] px-3.5 rounded-[17px] flex items-center justify-between transition-all duration-200 text-left overflow-hidden
                              ${active
                          ...
                          >
                            ...
                            <div className="flex min-w-0 items-center gap-3">
                              ...
                              <span className="truncate text-[13px] font-semibold tracking-[-0.018em]">
                                {item.label}
                              </span>
                            </div>
              ...
              <div className="mt-4 relative overflow-hidden rounded-[26px] border border-emerald-300/12 shadow-[0_18px_34px_rgba(0,0,0,0.28)]">
                <img
                  src={broilerHeroImg}
                  alt="Healthy Farmers Healthy India"
                  className="h-[218px] w-full object-cover object-center"
                />
                ...
                <div className="absolute inset-x-0 bottom-0 p-4">
                  <div className="font-['Caveat',cursive] text-[26px] leading-[0.88] font-bold tracking-wide text-white drop-shadow-[0_3px_8px_rgba(0,0,0,0.70)]">
                    Healthy Farmers
                  </div>
                  <div className="font-['Caveat',cursive] text-[26px] leading-none font-bold tracking-wide text-amber-300 drop-shadow-[0_3px_8px_rgba(0,0,0,0.70)]">
                    Healthy India
                  </div>
                  <div className="mt-3 rounded-2xl border border-white/18 bg-[#06291d]/72 px-3 py-2.5 backdrop-blur-md shadow-lg">
              ...
              <div className="mt-3 rounded-[22px] border border-white/10 bg-[linear-gradient(180deg,rgba(13,74,52,0.72),rgba(5,42,29,0.92))] p-3.5 shadow-[0_14px_28px_rgba(0,0,0,0.22)] backdrop-blur-xl">
                <button
